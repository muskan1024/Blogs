...
const NavBar = () => {
  return (
    <div className='relative w-full h-fit bg-white shadow-lg  opacity-90 z-40'>
        <div className='w-full h-full text-center p-2 flex justify-between  px-auto'>
            ...
            <div className=' grid gap-4 grid-cols-2 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 text-center '>
            ...
            <a href='admin' className='cols-span-2'><button className='text-white font-bold text-xl rounded p-1 px-4 hover:bg-sky-700 hover:rounded-3xl hover:py-1 bg-sky-500'>For Admin</button></a>
            </div>
        </div>
    </div>
  )
